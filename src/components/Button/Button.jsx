...
function Button( {children} ) {
  return (
    //  <button className='px-5 py-2 text-black bg-yellow-100 border rounded-sm tracking-wider'>{children}</button>
     <a href="#_" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border bg-yellow-100 rounded shadow-md group">
